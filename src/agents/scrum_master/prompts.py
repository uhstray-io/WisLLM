...
research_agent = create_react_agent(model="gpt-4o", tools=[web_search_tool, database_query_tool], name="research_expert")
...
def create_handoff_tool(agent_name: str):
    ...
    def handoff_to_agent(task_description: str, context: dict, state: Annotated[dict, InjectedState]):
        return Command(
